...
local ImageJob = function(item, ctx, fn)
    ...
    if Config.get_kenburns() then
        ...
        local paths = {
            {from = {x=0.0,  y=0.0,  s=1.0 }, to = {x=0.08, y=0.08, s=0.1 }}, --[["0.9"]]--
            {from = {x=0.05, y=0.0,  s=0.93}, to = {x=0.03, y=0.03, s=0.1}}, --[["0.97"]]--
            {from = {x=0.02, y=0.05, s=0.91}, to = {x=0.01, y=0.05, s=0.1}}, --[["0.95"]]--
            {from = {x=0.07, y=0.05, s=0.91}, to = {x=0.04, y=0.03, s=0.1}}, --[["0.95"]]--
        }
